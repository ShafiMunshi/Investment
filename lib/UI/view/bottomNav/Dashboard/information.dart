...
class Information extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: kAppbar(title: 'Information', context: context),
...
class PlanBoxWidget extends StatelessWidget {
  const PlanBoxWidget(
      ...
      required this.days,
      required this.add,
      required this.bonusDollar,
      required this.usdtEarn,
      required this.ontap,
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: const LinearGradient(
            ...
            colors: [AppColors.greenAccentclr, Colors.green]),
        ...
        children: [
          ...
          Text('$add Advertisement',
              style: TextStyle(
                  ...
                  fontWeight: FontWeight.w400,
                  fontFamily: 'gelion')),
          Text('$bonusDollar \$ sign up bonus',
              style: TextStyle(
                  color: Colors.white,
                  fontSize: 20.sp,
                  fontWeight: FontWeight.w400,
                  fontFamily: 'gelion')),
          Text('$usdtEarn USDT Daily Earn',
              style: TextStyle(
                  color: Colors.white,
                  fontSize: 20.sp,
                  fontWeight: FontWeight.w400,
          ...
          GestureDetector(
              onTap: ontap, child: loginWidget(Colors.blue, 'Deposit Now')),
        ],
      ),
    );
  }
